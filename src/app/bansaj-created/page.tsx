  ...
  return (
    ...
    >
      <div className="flex flex-col items-center space-y-8 ">
        <div className="bg-[#0051BA] bg-opacity-90 rounded-full lg:p-6 w-[300px] md:w-[500px] md:flex-row md:p-4 lg:w-[600px] flex-col lg:flex-row  p-2 flex justify-between items-center text-white  lg:space-x-32">
        ...
        <div className="bg-[#0051BA] bg-opacity-90 rounded-full lg:p-5 p-3 lg:w-[850px] md:w-[700px]  w-[350px] flex justify-around items-center text-white text-xl lg:space-x-64 md:space-x-32 space-x-6">
          <div className="flex flex-col items-center space-y-1  ml-0">
